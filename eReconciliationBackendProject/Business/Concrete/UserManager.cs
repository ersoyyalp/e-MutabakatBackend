...
namespace Business.Concrete
{
    public class UserManager : IUserService
    {
        ...
        public UserManager(IUserDal userDal, IUserOperationClaimService userOperationClaimService, IOperationClaimService operationClaimService, ICompanyService companyService, IUserCompanyService userCompanyService,IUserReletionShipService userReletionShipService)
        {
            _userDal = userDal;
