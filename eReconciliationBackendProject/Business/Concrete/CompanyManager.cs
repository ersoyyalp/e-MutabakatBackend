...
namespace Business.Concrete
{
    ...
    {
        private readonly ICompanyDal _companyDal;//Dependency Injection
        ...
        [CacheRemoveAspect("ICompanyService.Get")]
        [ValidationAspect(typeof(CompanyValidator))]//Validation Aspect
        [TransactionScopeAspect]
        public IResult AddCompanyAndUserCompany(CompanyDto companyDto)
        {//Şirket ile kullanıcı arası bağlantı
        ...
        //Bu işlemi yapmaya Kullanıcı Yetkili mi yetkiliyse;
        //Transaction gerektiren herhangi bir durum var mı
        //Log
        //Validation
        //Bunlarda sıkıntı yoksa bu işlemi yap
