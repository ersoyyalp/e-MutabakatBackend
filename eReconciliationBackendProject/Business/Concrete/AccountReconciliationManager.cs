...
namespace Business.Concrete
{
    public class AccountReconciliationManager : IAccountReconciliationService
    {
        ...
        public IResult SendReconciliationMail(int id)
        {
            ...
            string body = $"Şirketimiz: {accountReconciliationDto.CompanyName} <br /> " +
                $"Şirketimizin Vergi Dairesi: {accountReconciliationDto.CompanyTaxDepartment} <br />" +
                $"Şirketimizin Vergi Numarası: {accountReconciliationDto.CompanyTaxIdNumber} - {accountReconciliationDto.CompanyIdentityNumber} <br /><hr>" +
                $"Sizin Şirketiniz: {accountReconciliationDto.AccountName} <br />" +
                $"Sizin Şirketinizin Vergi Dairesi: {accountReconciliationDto.AccountTaxDepartment} <br />" +
                $"Sizin Şirketinizin Vergi Numarası: {accountReconciliationDto.AccountTaxIdNumber} - {accountReconciliationDto.AccountIdentityNumber} <br /><hr>" +
